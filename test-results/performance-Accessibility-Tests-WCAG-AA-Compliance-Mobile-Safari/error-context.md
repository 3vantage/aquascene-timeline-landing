...
- main:
  - main:
    ...
    - img
    - text: EARLY ACCESS • 3D AQUASCAPE DESIGNER
    - heading "Design Your Dream Aquascape" [level=1]
    - paragraph: Plan Before You Plant • Save Money, Avoid Mistakes • Join 2487+ Bulgarian & Hungarian Aquascapers
    - text: 3D Visualization Cost Calculator Expert Community
    - button "Start Designing NowStart Designing"
    - button "Watch 3D Demo3D Demo"
    - text: "🇧🇬 🇭🇺 🇷🇴 🇸🇮 🇦🇹 2,487+ Aquascapers Waiting From Bulgaria, Hungary & Central Europe 3 aquascapers joined in the last hour3 joined recently 3D View3D Real-time Cost: $127 Auto-calculated CO₂: 2.5ppm Optimal"
    - button "Try Interactive DemoDemo"
    - img
    - text: A B C +
    - paragraph: Join
    - paragraph: 1,247
    ...
    - img
    - heading "3D Visualization EnginePopular" [level=3]
    ...
    - text: 00 Days 00 Hours 00 Minutes 00 Seconds
    - paragraph: Don't miss your chance to be among the first users!
    - text: 🔥 LIMITED SPOTS Limited 47spots remaining
    ...
    - img
    - text: Special launch pricing discounts A B C D Join the Community 2,500+ aquascapers already signed up Form Progress0% Complete
    ...
    - button "✨ Reserve My Spot" [disabled]
    - paragraph:
