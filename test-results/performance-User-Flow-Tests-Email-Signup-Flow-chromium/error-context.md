...
- main:
  - main:
    ...
    - button "Watch 3D Demo"
    - text: 🇧🇬 🇭🇺 🇷🇴 🇸🇮 🇦🇹 2,487+ Waiting From Bulgaria, Hungary & Central Europe 3 aquascapers joined in the last hour 3D Real-time $127 Auto-calculated 2.5ppm Optimal
    ...
    - text: 06 Days 23 Hours 59 Minutes 36 Seconds
    ...
    - button "🎁 Get Free Design Tools Plus 15% off Green Aqua" [disabled]
    - paragraph:
    ...
    - text: "Scroll: 74% | Aquarium Depth: 73.99114592201602%"
